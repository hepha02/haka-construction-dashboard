import{createClient as bt}from"https://esm.sh/@supabase/supabase-js@2.49.1";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const ht="https://yqemtsbdnypgmkuyncxh.supabase.co",yt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlxZW10c2JkbnlwZ21rdXluY3hoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAyNjYwMTUsImV4cCI6MjA5NTg0MjAxNX0.gwgdCncqRKKgC8ebj7qIdT-vA4J-wOVd2O9DSa7xEOs",l=bt(ht,yt),Y="construction-start-files",X="payment-files",Z="vendor-files",ot=["철거","금속공사","목작업","목자재","전기","전기자재","간판","임시간판","돌출간판","실내광고외","광고 시트","자판기 유리작업","자동문 /강화도어","자동문","강화도어","페인트자재","도장공사","타일자재","타일 부자재","타일시공","타일","싱크 개수대","설비","진열장","카운터 역채널","인조대리석","유리/무늬목작접등 기타잡비","유리","무늬목","기타잡비","스카이","에어컨","소방설비","가구운송","엠프","오픈현수막","열쇠/철물","열쇠","철물","청소","폐기물","추가공사","기타"],b={payments:[],stores:[{id:1,name:"성수 플래그십",area:52,status:"완료",budget:21e7,spent:1984e5},{id:2,name:"부산 센텀",area:47,status:"진행중",budget:186e6,spent:1227e5},{id:3,name:"대전 둔산",area:39,status:"진행중",budget:144e6,spent:882e5},{id:4,name:"제주 노형",area:42,status:"미착공",budget:158e6,spent:0}],vendors:[{id:1,name:"도원인테리어",category:"시공",bank:"신한은행",account_number:"110-000-000001",account_holder:"도원인테리어",risk:"정상",total:1245e5},{id:2,name:"한빛전기",category:"전기",bank:"국민은행",account_number:"004-000-000002",account_holder:"한빛전기",risk:"정상",total:738e5},{id:3,name:"서진설비",category:"설비",bank:"하나은행",account_number:"352-000-000003",account_holder:"서진설비",risk:"증빙확인",total:412e5}],userRoles:[],paymentItems:ot,constructionStarts:[]},rt=[{group:"벽장",name:"상부장",baseUnit:115600,allocationUnit:57100,quantity:40,madeAmount:126e4},{group:"벽장",name:"하부장",baseUnit:167500,allocationUnit:63500,quantity:40,madeAmount:224e4},{group:"진열장",name:"유리장",baseUnit:287e3,allocationUnit:163500,quantity:40,madeAmount:266e4},{group:"카운터",name:"카운터 서랍형 1200",baseUnit:831200,allocationUnit:727200,quantity:10,madeAmount:56e4},{group:"카운터",name:"카운터 선반형 1800",baseUnit:395800,allocationUnit:395800,quantity:4,madeAmount:256e3},{group:"카운터",name:"카운터 선반형 1600",baseUnit:350600,allocationUnit:350600,quantity:2,madeAmount:122e3},{group:"테이블",name:"테이블 600*1200",baseUnit:22e4,allocationUnit:161e3,quantity:5,madeAmount:805e3},{group:"도장",name:"도장 / 총 58통",baseUnit:18e4,allocationUnit:18e4,quantity:4,madeAmount:72e4}],st=["대시보드","엑셀 업로드","공사 시작 접수","결제 신청","결제 계좌 관리","매장별 공사 관리","진열장 원가 배분","견적서 생성","계약서 생성","은행 이체 파일 생성","관리자 설정"],T={"전체 관리자":st,"인테리어 공사실장":["공사 시작 접수","결제 신청","결제 계좌 관리","진열장 원가 배분","은행 이체 파일 생성"]},it={admin:"전체 관리자",interior_manager:"인테리어 공사실장","전체 관리자":"전체 관리자","인테리어 공사실장":"인테리어 공사실장"},_t={"엑셀 업로드":["결제 신청 내역 엑셀 업로드","필수 컬럼 검증","중복/오류 행 표시"],"진열장 원가 배분":["매장별 진열장 비용 배분","공용 비용 자동 분배","평당 원가 반영"],"견적서 생성":["매장/업체 기준 견적서 생성","공사항목별 금액 자동 합산","PDF/문서 다운로드"],"계약서 생성":["업체 정보 기반 계약서 생성","계좌/사업자 정보 자동 반영","계약 상태 관리"],"은행 이체 파일 생성":["승인된 결제 건만 추출","은행 업로드용 파일 생성","이체 전 검증"],"관리자 설정":["사용자 권한","승인 단계","상태/분류 코드 관리"]};let h=b,f="대시보드",x="인테리어 공사실장",y=null;const g=e=>new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW",maximumFractionDigits:0}).format(e||0),O=()=>new Date().toISOString().slice(0,10),E=e=>Number(String(e).replace(/[^\d]/g,"")),N=e=>Number(e||0),I=(e,t)=>String(e||"").trim().slice(0,t),vt=e=>String(e||"").replace(/[^\d]/g,""),$t=e=>({"일시 지급":1,"선금 50%":.5,"잔금 50%":.5})[e]||0,lt=e=>e==="사업소득 3.3%"?.033:0,_=e=>String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),P=e=>String(e||"file").replace(/[^\w.\-가-힣]/g,"_"),U=e=>({승인:"green",신청:"amber",반려:"red",진행중:"blue",완료:"green",미착공:"gray",정상:"green",증빙확인:"amber"})[e]||"gray";async function q(){if(!l)return b;const[e,t,a,o,n,r]=await Promise.all([l.from("payments").select("*").order("requested_at",{ascending:!1}).order("id",{ascending:!1}).limit(500),l.from("stores").select("*").order("id",{ascending:!0}),l.from("vendors").select("*").order("id",{ascending:!0}),l.from("construction_starts").select("*").order("created_at",{ascending:!1}).order("id",{ascending:!1}).limit(30),l.from("user_roles").select("email, role, created_at").order("email",{ascending:!0}),l.from("construction_cost_parts").select("part_name").order("part_name",{ascending:!0})]),s=r.error?b.paymentItems:[...new Set([...ot,...r.data.map(i=>i.part_name).filter(Boolean)])];return{payments:e.error?b.payments:e.data,stores:t.error?b.stores:t.data,vendors:a.error?b.vendors:a.data,constructionStarts:o.error?b.constructionStarts:o.data,userRoles:n.error?b.userRoles:n.data,paymentItems:s}}async function ct(e){if(!l||!(e!=null&&e.email))return"인테리어 공사실장";const{data:t,error:a}=await l.from("user_roles").select("role").ilike("email",e.email).maybeSingle();return a||!(t!=null&&t.role)?"인테리어 공사실장":it[t.role]||"인테리어 공사실장"}async function wt(){var t;if(!l){h=await q(),x="전체 관리자",v();return}const{data:e}=await l.auth.getSession();if(y=((t=e.session)==null?void 0:t.user)||null,!y){k();return}x=await ct(y),f=S()[0],h=await q(),v()}function St(e,t,a){return e.payments.find(o=>{const n=o.vendor.trim()===t.trim(),r=Math.abs(o.amount-a)/Math.max(a,1);return n&&r<=.1})}function kt(e,t,a){return e.payments.find(o=>{const n=String(o.store||"").trim()===t.trim(),r=String(o.payment_item||"").trim()===a.trim();return n&&r})}async function G(e,t){const a=Array.from(e||[]).filter(n=>n.size>0);if(!a.length)return[];if(!l)return a.map(n=>({name:n.name,type:n.type,size:n.size,path:"",url:""}));const o=[];for(const n of a){const r=`${(y==null?void 0:y.id)||"user"}/${t}/${Date.now()}-${crypto.randomUUID()}-${P(n.name)}`,{error:s}=await l.storage.from(Y).upload(r,n,{contentType:n.type,upsert:!1});if(s)throw s;const{data:i}=l.storage.from(Y).getPublicUrl(r);o.push({name:n.name,type:n.type,size:n.size,path:r,url:i.publicUrl})}return o}async function D(e,t){const a=Array.from(e||[]).filter(n=>n.size>0);if(!a.length)return[];if(!l)return a.map(n=>({name:n.name,type:n.type,size:n.size,path:"",url:""}));const o=[];for(const n of a){const r=`${(y==null?void 0:y.id)||"user"}/${t}/${Date.now()}-${crypto.randomUUID()}-${P(n.name)}`,{error:s}=await l.storage.from(X).upload(r,n,{contentType:n.type,upsert:!1});if(s)throw s;const{data:i}=l.storage.from(X).getPublicUrl(r);o.push({name:n.name,type:n.type,size:n.size,path:r,url:i.publicUrl})}return o}async function Q(e,t){const a=Array.from(e||[]).filter(n=>n.size>0);if(!a.length)return[];if(!l)return a.map(n=>({name:n.name,type:n.type,size:n.size,path:"",url:""}));const o=[];for(const n of a){const r=`${(y==null?void 0:y.id)||"user"}/${t}/${Date.now()}-${crypto.randomUUID()}-${P(n.name)}`,{error:s}=await l.storage.from(Z).upload(r,n,{contentType:n.type,upsert:!1});if(s)throw s;const{data:i}=l.storage.from(Z).getPublicUrl(r);o.push({name:n.name,type:n.type,size:n.size,path:r,url:i.publicUrl})}return o}async function xt(e){e.preventDefault();const t=e.currentTarget,a=t.querySelector("button[type='submit']"),o=t.querySelector("[data-form-message]"),n=new FormData(t),r=String(n.get("store")||"").trim(),s=String(n.get("vendor")||"").trim(),i=String(n.get("payment_item")||"").trim(),m=E(n.get("estimate_total")),d=String(n.get("payment_type")||"일시 지급"),c=E(n.get("amount")),u=String(n.get("tax_type")||"일반 송금"),C=Math.round(c*lt(u)),p=c-C,z=String(n.get("vendor_bank")||"").trim(),M=String(n.get("vendor_account_number")||"").trim(),j=String(n.get("vendor_account_holder")||"").trim(),gt=String(n.get("memo")||"").trim(),A=St(h,s,c),V=kt(h,r,i),B=n.getAll("estimate_files").filter(w=>w.size>0),K=n.getAll("tax_invoice_files").filter(w=>w.size>0),W=n.getAll("id_card_files").filter(w=>w.size>0);if(!r||!s||!i||!m||!c||!z||!M||!j){o.textContent="매장명, 업체, 결제 항목, 견적 총액, 신청 금액, 이체 계좌를 모두 입력해 주세요.",o.className="form-message error";return}if(u==="일반 송금"&&(!B.length||!K.length)){o.textContent="일반 송금은 견적서와 세금계산서를 첨부해야 합니다.",o.className="form-message error";return}if(u==="사업소득 3.3%"&&!W.length){o.textContent="사업소득 3.3% 지급은 주민등록증 첨부가 필요합니다.",o.className="form-message error";return}a.disabled=!0,a.textContent="저장 중",o.textContent="첨부 자료를 업로드하고 있습니다.",o.className=A?"form-message warning":"form-message";let J={};try{J={estimate_files:await D(B,"estimates"),tax_invoice_files:await D(K,"tax-invoices"),id_card_files:await D(W,"id-cards")}}catch(w){a.disabled=!1,a.textContent="검토 요청 생성",o.textContent=`첨부 업로드 실패: ${w.message}`,o.className="form-message error";return}o.textContent=A?`중복 의심: ${A.store} / ${g(A.amount)} 건과 비슷합니다.`:V?`확인 필요: ${r} / ${i} 항목에 기존 신청이 있습니다. 중복이 아니면 견적서에는 같은 항목 합계로 반영됩니다.`:"신청 건을 저장하고 있습니다.",o.className=A||V?"form-message warning":"form-message";const H={store:r,vendor:s,payment_item:i,estimate_total:m,payment_type:d,amount:c,vendor_bank:z,vendor_account_number:M,vendor_account_holder:j,tax_type:u,withholding_amount:C,net_amount:p,attachment_files:J,estimate_group_mode:"매장별 항목 합산",estimate_group_key:`${r}::${i}`,memo:gt,status:"신청",requested_at:O()};if(!l)b.payments=[{id:Date.now(),...H},...b.payments];else{const{error:w}=await l.from("payments").insert(H);if(w){a.disabled=!1,a.textContent="검토 요청 생성",o.textContent=`저장 실패: ${w.message}`,o.className="form-message error";return}}t.reset(),h=await q(),v(A?"신청이 저장됐습니다. 중복 의심 건은 결제 검토에서 확인하세요.":"신청이 저장됐습니다.")}async function qt(e){var c;e.preventDefault();const t=e.currentTarget,a=t.querySelector("button[type='submit']"),o=t.querySelector("[data-vendor-message]"),n=new FormData(t),r=Number(n.get("vendor_id")||0),s={name:String(n.get("name")||"").trim(),category:String(n.get("category")||"").trim(),bank:String(n.get("bank")||"").trim(),account_number:String(n.get("account_number")||"").trim(),account_holder:String(n.get("account_holder")||"").trim()},i=n.getAll("business_license_files").filter(u=>u.size>0),m=n.getAll("bankbook_files").filter(u=>u.size>0);if(!s.name||!s.category||!s.bank||!s.account_number||!s.account_holder){o.textContent="업체명, 분류, 은행, 계좌번호, 예금주를 모두 입력해 주세요.",o.className="form-message error";return}if(!r&&(!i.length||!m.length)){o.textContent="최초 등록 시 사업자등록증과 통장사본을 모두 첨부해 주세요.",o.className="form-message error";return}a.disabled=!0,a.textContent="저장 중",o.textContent="첨부 자료를 업로드하고 있습니다.",o.className="form-message";let d={};try{const u=r?((c=h.vendors.find(C=>C.id===r))==null?void 0:c.attachment_files)||{}:{};d={business_license_files:[...u.business_license_files||[],...await Q(i,"business-licenses")],bankbook_files:[...u.bankbook_files||[],...await Q(m,"bankbooks")]}}catch(u){a.disabled=!1,a.textContent="계좌 저장",o.textContent=`첨부 업로드 실패: ${u.message}`,o.className="form-message error";return}if(s.attachment_files=d,o.textContent="결제 계좌 정보를 저장하고 있습니다.",!l)b.vendors=r?b.vendors.map(u=>u.id===r?{...u,...s}:u):[{id:Date.now(),...s,risk:"정상",total:0},...b.vendors];else{const{error:u}=r?await l.from("vendors").update(s).eq("id",r):await l.from("vendors").insert(s);if(u){a.disabled=!1,a.textContent="계좌 저장",o.textContent=`저장 실패: ${u.message}`,o.className="form-message error";return}}t.reset(),h=await q(),f="결제 계좌 관리",v(r?"결제 계좌 정보가 수정됐습니다.":"결제 계좌 정보가 저장됐습니다.")}async function Ct(e){e.preventDefault();const t=e.currentTarget,a=t.querySelector("button[type='submit']"),o=t.querySelector("[data-store-message]"),n=new FormData(t),r={name:String(n.get("name")||"").trim(),area:Number(n.get("area")),status:String(n.get("status")||"미착공"),budget:E(n.get("budget")),spent:E(n.get("spent"))};if(!r.name||!r.area||!r.budget){o.textContent="매장명, 면적, 예산을 입력해 주세요.",o.className="form-message error";return}if(a.disabled=!0,a.textContent="저장 중",o.textContent="매장 공사 정보를 저장하고 있습니다.",o.className="form-message",!l)b.stores=[{id:Date.now(),...r},...b.stores];else{const{error:s}=await l.from("stores").insert(r);if(s){a.disabled=!1,a.textContent="매장 저장",o.textContent=`저장 실패: ${s.message}`,o.className="form-message error";return}}t.reset(),h=await q(),f="매장별 공사 관리",v("매장 공사 정보가 저장됐습니다.")}async function At(e){e.preventDefault();const t=e.currentTarget,a=t.querySelector("button[type='submit']"),o=t.querySelector("[data-construction-start-message]"),n=new FormData(t),r=N(n.get("wall_cabinet_count")),s=N(n.get("display_fixture_count")),i=N(n.get("counter_count")),m={store_name:String(n.get("store_name")||"").trim(),area:Number(n.get("area")),wall_cabinet_count:r,display_fixture_count:s,counter_count:i,fixture_count:r+s+i,table_count:Number(n.get("table_count")||0),sign_count:Number(n.get("sign_count")||0),special_notes:String(n.get("special_notes")||"").trim()};if(!m.store_name||!m.area){o.textContent="매장명과 평수는 꼭 입력해 주세요.",o.className="form-message error";return}a.disabled=!0,a.textContent="저장 중",o.textContent="도면과 사진 파일을 업로드하고 있습니다.",o.className="form-message";try{m.drawing_files=await G(n.getAll("drawing_files"),"drawings"),m.base_photo_files=await G(n.getAll("base_photo_files"),"base-photos")}catch(d){a.disabled=!1,a.textContent="공사 시작 정보 저장",o.textContent=`파일 업로드 실패: ${d.message}`,o.className="form-message error";return}if(o.textContent="공사 시작 정보를 저장하고 있습니다.",!l)b.constructionStarts=[{id:Date.now(),created_at:new Date().toISOString(),...m},...b.constructionStarts];else{const{error:d}=await l.from("construction_starts").insert(m);if(d){a.disabled=!1,a.textContent="공사 시작 정보 저장",o.textContent=`저장 실패: ${d.message}`,o.className="form-message error";return}}t.reset(),h=await q(),f="공사 시작 접수",v("공사 시작 정보가 저장됐습니다. 결제 신청 매장 검색에도 반영됐습니다.")}async function Nt(e,t){if(!(!e||!["승인","반려"].includes(t))){if(!l)b.payments=b.payments.map(a=>a.id===e?{...a,status:t}:a);else{const{error:a}=await l.from("payments").update({status:t}).eq("id",e).eq("status","신청");if(a){v(`상태 변경 실패: ${a.message}`);return}}h=await q(),f="결제 신청",v(`결제 신청이 ${t} 처리됐습니다.`)}}function Et(e){var o;const t=String(e||"").replace(/\s/g,"");return((o=[["신한","신한"],["국민","국민"],["기업","기업"],["우리","우리"],["하나","하나"],["농협","농협"],["축협","농협"],["카카오","카카오"],["토스","토스"],["케이뱅크","케이뱅크"],["부산","부산"],["대구","아이엠뱅크"],["아이엠","아이엠뱅크"],["새마을","새마을금고"],["신협","신협"],["우체국","우체국"],["전북","전북"],["광주","광주"],["경남","경남"],["수협","수협"]].find(([n])=>t.includes(n)))==null?void 0:o[1])||I(e,6)}function It(e,t){const a=String(t.vendor||"").trim();return e.vendors.find(o=>String(o.name||"").trim()===a)||{}}function Rt(e){return e.payments.filter(t=>t.status==="승인")}function Ut(e,t){const a=It(e,t),o=t.vendor_bank||a.bank,n=t.vendor_account_number||a.account_number,r=t.vendor_account_holder||a.account_holder||t.vendor,s=Number(t.net_amount||t.amount||0),i=`${t.store||""} ${t.payment_item||""}`.trim();return{bank:Et(o),account:vt(n),holder:r,amount:s,withdrawMemo:"하카공사비",depositMemo:I(r,7),payerCode:"",memo:I(i,10),key:I(`${t.id||""}-${t.requested_at||O()}`,20),payment:t,vendor:a,ready:!!(o&&n&&r&&s>0)}}function L(e){return Rt(e).map(t=>Ut(e,t))}function tt(e,t=""){return`<td${t?` style="${t}"`:""}>${_(e)}</td>`}function Lt(e){const t=L(e).filter(d=>d.ready);if(!t.length){v("다운로드할 승인 완료 건이 없거나, 업체 계좌정보가 비어 있습니다.");return}const a=["*입금은행","*입금계좌","고객관리성명","*입금액","출금통장표시내용","입금통장표시내용","입금인코드","비고","업체사용key"],o=t.map(d=>[d.bank,d.account,d.holder,d.amount,d.withdrawMemo,d.depositMemo,d.payerCode,d.memo,d.key]),r=`
  ...
  `}function Tt(e){return e.payments.map(t=>`
      ...
      </tr>`)}function Pt(e){return L(e).map(t=>`
      <tr>
      ...
      </tr>`)}function ut(e){return e.stores.map(t=>`
      <tr>
        <td>${t.region||"-"}</td>
        <td>${t.name}</td>
      ...
      <tr>
      ...
      </tr>`)}function mt(e){return e.vendors.map(t=>{const a=t.attachment_files||{},o=(a.business_license_files||[]).length,n=(a.bankbook_files||[]).length;return`
        <tr>
          <td>${t.name}</td>
          <td>${t.category}</td>
          <td>${t.bank}</td>
        ...
        </tr>`})}function Mt(e){return e.vendors.map(t=>`<option value="${_(t.name)}">${_(t.name)} / ${_(t.bank)} ${_(t.account_number||"")}</option>`).join("")}function jt(e){const a=[...e.constructionStarts.map(n=>({name:n.store_name,area:n.area,status:"공사 시작 접수"})),...e.stores],o=new Set;return a.filter(n=>{const r=String(n.name||"").trim();return!r||o.has(r)?!1:(o.add(r),!0)}).map(n=>`<option value="${_(n.name)}">${_(n.name)} / ${_(n.area)}평 / ${_(n.status)}</option>`).join("")}function Vt(e){return e.paymentItems.map(t=>`<option value="${_(t)}">${_(t)}</option>`).join("")}function pt(){return`
  ...
  `}function Jt(e){return`
    ...
    <section class="grid two">
      ...
      <article class="panel">
        ...
        ${$(["지역","매장","진열장","평수","공사비 합계","상태","문서"],ut(e))}
      </article>
    </section>
    ...
    <section class="grid lower">
      <article class="panel">
        ...
        ${$(["업체","분류","은행","계좌번호","예금주","첨부","상태","수정"],mt(e))}
      </article>
      ${pt()}
    </section>
  `}function Ht(e){const t=L(e).filter(a=>a.ready).length;return`
    <section class="grid two">
      ${pt()}
      <article class="panel">
        <div class="panel-head">
  ...
  `}function Yt(e){const t=L(e),a=t.filter(n=>n.ready).length,o=t.filter(n=>n.ready).reduce((n,r)=>n+r.amount,0);return`
    <section class="grid two">
      <article class="panel">
        <div class="panel-head">
          <h2>은행 대량이체 파일</h2>
  ...
  `}function ft(e){return e.quantity&&e.madeAmount?Math.round(e.madeAmount/e.quantity):e.allocationUnit||e.baseUnit||0}function F(e){const t=rt.filter(o=>o.group===e),a=t.reduce((o,n)=>o+ft(n),0);return e==="카운터"?Math.round(a/Math.max(t.length,1)):a}function Zt(){return rt.map(e=>`
      <tr>
        <td>${e.group}</td>
        <td>${e.name}</td>
  ...
  `}function se(e){return f==="대시보드"?Jt(e):f==="공사 시작 접수"?Xt(e):f==="결제 신청"?Ht(e):f==="결제 계좌 관리"||f==="업체/계좌 관리"?te(e):f==="매장별 공사 관리"?ee(e):f==="진열장 원가 배분"?Qt(e):f==="은행 이체 파일 생성"?Yt(e):f==="관리자 설정"?oe(e):re(f)}function S(){return T[x]||st}function ie(){return`
  ...
  `,document.querySelector("#auth-form").addEventListener("submit",le),document.querySelector("[data-auth-action='signup']").addEventListener("click",ce),document.querySelector("[data-auth-action='resend']").addEventListener("click",ue)}async function le(e){e.preventDefault();const t=new FormData(e.currentTarget),a=String(t.get("email")||"").trim(),o=String(t.get("password")||"");if(!a||!o){k("이메일과 비밀번호를 입력해 주세요.");return}const{data:n,error:r}=await l.auth.signInWithPassword({email:a,password:o});if(r){k(`로그인 실패: ${r.message}`);return}y=n.user,x=await ct(y),f=S()[0],h=await q(),v()}async function ce(){const e=document.querySelector("#auth-form"),t=new FormData(e),a=String(t.get("email")||"").trim(),o=String(t.get("password")||"");if(!a||!o){k("계정을 만들 이메일과 비밀번호를 입력해 주세요.");return}const{error:n}=await l.auth.signUp({email:a,password:o,options:{emailRedirectTo:window.location.origin+window.location.pathname}});if(n){k(`회원가입 실패: ${n.message}`);return}k("계정이 생성됐습니다. 이메일 확인이 필요한 경우 메일 인증 후 로그인해 주세요.")}async function ue(){const e=document.querySelector("#auth-form"),t=new FormData(e),a=String(t.get("email")||"").trim();if(!a){k("인증메일을 다시 받을 이메일을 입력해 주세요.");return}const{error:o}=await l.auth.resend({type:"signup",email:a,options:{emailRedirectTo:window.location.origin+window.location.pathname}});if(o){k(`인증메일 재발송 실패: ${o.message}`);return}k("인증메일을 다시 보냈습니다. 새로 받은 메일의 링크를 눌러 주세요.")}async function de(){await l.auth.signOut(),y=null,x="인테리어 공사실장",k("로그아웃되었습니다.")}function v(e=""){var s,i,m,d,c,u,C;const t=document.querySelector("#app");t.className="",S().includes(f)||(f=S()[0]),t.innerHTML=`
    <aside class="sidebar">
      <div class="brand">
        <span class="brand-mark">H</span>
        <div>
      ...
      <nav>
        ${S().map(p=>`<button data-view="${p}" class="${p===f?"active":""}">${p}</button>`).join("")}
      </nav>
    </aside>
    <main class="shell">
      <header class="topbar">
  ...
  `,document.querySelectorAll("[data-view]").forEach(p=>{p.addEventListener("click",()=>{f=p.dataset.view,v()})}),document.querySelectorAll("[data-role]").forEach(p=>{p.addEventListener("click",()=>{x=p.dataset.role,S().includes(f)||(f=S()[0]),v()})}),(s=document.querySelector("[data-sign-out]"))==null||s.addEventListener("click",de),document.querySelectorAll("[data-view-link]").forEach(p=>{p.addEventListener("click",()=>{S().includes(p.dataset.viewLink)&&(f=p.dataset.viewLink),v()})});const a=document.querySelector("#payment-form");a&&(a.addEventListener("submit",xt),(i=a.querySelector("[name='vendor']"))==null||i.addEventListener("input",()=>nt(a)),(m=a.querySelector("[name='vendor']"))==null||m.addEventListener("change",()=>nt(a)),(d=a.querySelector("[name='estimate_total']"))==null||d.addEventListener("input",()=>et(a)),(c=a.querySelector("[name='payment_type']"))==null||c.addEventListener("change",()=>et(a)),(u=a.querySelector("[name='amount']"))==null||u.addEventListener("input",()=>R(a)),(C=a.querySelector("[name='tax_type']"))==null||C.addEventListener("change",()=>R(a)),R(a));const o=document.querySelector("#vendor-form");o&&o.addEventListener("submit",qt),document.querySelectorAll("[data-vendor-edit]").forEach(p=>{p.addEventListener("click",()=>Dt(Number(p.dataset.vendorEdit)))});const n=document.querySelector("#store-form");n&&n.addEventListener("submit",Ct);const r=document.querySelector("#construction-start-form");r&&r.addEventListener("submit",At),document.querySelectorAll("[data-bank-transfer-download]").forEach(p=>{p.addEventListener("click",()=>Lt(h))}),document.querySelectorAll("[data-payment-id][data-payment-status]").forEach(p=>{p.addEventListener("click",()=>{Nt(Number(p.dataset.paymentId),p.dataset.paymentStatus)})})}wt();
