import{createClient as ne}from"https://esm.sh/@supabase/supabase-js@2.49.1";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const ae={},Ft=ae||{},yt=Ft.VITE_SUPABASE_URL||"https://yqemtsbdnypgmkuyncxh.supabase.co",$t=Ft.VITE_SUPABASE_ANON_KEY||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlxZW10c2JkbnlwZ21rdXluY3hoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAyNjYwMTUsImV4cCI6MjA5NTg0MjAxNX0.gwgdCncqRKKgC8ebj7qIdT-vA4J-wOVd2O9DSa7xEOs";var Tt,Rt;const dt=typeof window<"u"&&["localhost","127.0.0.1"].includes(((Tt=window.location)==null?void 0:Tt.hostname)||"")&&new URLSearchParams(((Rt=window.location)==null?void 0:Rt.search)||"").has("preview"),u=!dt&&yt&&$t?ne(yt,$t):null,wt="construction-start-files",St="payment-files",kt="vendor-files",Nt=["철거","금속공사","목작업","목자재","전기","전기자재","간판","임시간판","돌출간판","실내광고외","광고 시트","자판기 유리작업","자동문 /강화도어","자동문","강화도어","페인트자재","도장공사","타일자재","타일 부자재","타일시공","타일","싱크 개수대","설비","진열장","카운터 역채널","인조대리석","유리/무늬목작접등 기타잡비","유리","무늬목","기타잡비","스카이","에어컨","소방설비","가구운송","엠프","오픈현수막","열쇠/철물","열쇠","철물","청소","폐기물","추가공사","기타"],b={payments:[],stores:[{id:1,name:"성수 플래그십",area:52,status:"완료",budget:21e7,spent:1984e5},{id:2,name:"부산 센텀",area:47,status:"진행중",budget:186e6,spent:1227e5},{id:3,name:"대전 둔산",area:39,status:"진행중",budget:144e6,spent:882e5},{id:4,name:"제주 노형",area:42,status:"미착공",budget:158e6,spent:0}],vendors:[{id:1,name:"도원인테리어",category:"시공",bank:"신한은행",account_number:"110-000-000001",account_holder:"도원인테리어",risk:"정상",total:1245e5},{id:2,name:"한빛전기",category:"전기",bank:"국민은행",account_number:"004-000-000002",account_holder:"한빛전기",risk:"정상",total:738e5},{id:3,name:"서진설비",category:"설비",bank:"하나은행",account_number:"352-000-000003",account_holder:"서진설비",risk:"증빙확인",total:412e5}],userRoles:[],paymentItems:Nt,constructionStarts:[],storeQuotes:[]},oe={...b,payments:[{id:101,store:"성수 플래그십",vendor:"도원인테리어",payment_item:"목작업",estimate_total:12e6,payment_type:"선금 50%",amount:6e6,vendor_bank:"신한은행",vendor_account_number:"110-000-000001",vendor_account_holder:"도원인테리어",tax_type:"일반 송금",withholding_amount:0,net_amount:6e6,attachment_files:{estimate_files:[{name:"성수_목작업_견적서.pdf",size:245760,url:"#"}],tax_invoice_files:[{name:"성수_목작업_세금계산서.pdf",size:184320,url:"#"}]},estimate_group_mode:"매장별 항목 합산",estimate_group_key:"성수 플래그십::목작업",memo:"미리보기 승인 건",status:"승인",requested_at:"2026-08-25",transfer_status:"미작성"},{id:102,store:"부산 센텀",vendor:"한빛전기",payment_item:"전기",estimate_total:88e5,payment_type:"일시 지급",amount:88e5,vendor_bank:"국민은행",vendor_account_number:"004-000-000002",vendor_account_holder:"한빛전기",tax_type:"사업소득 3.3%",withholding_amount:290400,net_amount:8509600,attachment_files:{id_card_files:[{name:"한빛전기_신분증.pdf",size:126e3,url:"#"}]},estimate_group_mode:"매장별 항목 합산",estimate_group_key:"부산 센텀::전기",memo:"파일 생성 완료 샘플",status:"승인",requested_at:"2026-08-24",transfer_status:"파일생성",exported_at:"2026-08-26T09:20:00+09:00",transfer_batch_id:"TR-PREVIEW-001"},{id:103,store:"대전 둔산",vendor:"계좌미등록업체",payment_item:"설비",estimate_total:43e5,payment_type:"일시 지급",amount:43e5,vendor_bank:"",vendor_account_number:"",vendor_account_holder:"",tax_type:"일반 송금",withholding_amount:0,net_amount:43e5,attachment_files:{},estimate_group_mode:"매장별 항목 합산",estimate_group_key:"대전 둔산::설비",memo:"계좌 확인 필요 샘플",status:"승인",requested_at:"2026-08-23",transfer_status:"미작성"},{id:104,store:"제주 노형",vendor:"도원인테리어",payment_item:"타일",estimate_total:32e5,payment_type:"일시 지급",amount:32e5,vendor_bank:"신한은행",vendor_account_number:"110-000-000001",vendor_account_holder:"도원인테리어",tax_type:"일반 송금",withholding_amount:0,net_amount:32e5,attachment_files:{},estimate_group_mode:"매장별 항목 합산",estimate_group_key:"제주 노형::타일",memo:"송금완료 제외 샘플",status:"승인",requested_at:"2026-08-22",transfer_status:"송금완료",transferred_at:"2026-08-26T14:30:00+09:00"},{id:105,store:"성수 플래그십",vendor:"서진설비",payment_item:"소방설비",estimate_total:28e5,payment_type:"잔금 50%",amount:14e5,vendor_bank:"하나은행",vendor_account_number:"352-000-000003",vendor_account_holder:"서진설비",tax_type:"일반 송금",withholding_amount:0,net_amount:14e5,attachment_files:{},estimate_group_mode:"매장별 항목 합산",estimate_group_key:"성수 플래그십::소방설비",memo:"승인 전 검토 샘플",status:"신청",requested_at:"2026-08-27",transfer_status:"미작성"}],constructionStarts:[{id:201,store_name:"부산 센텀",area:47,drawing_note:"도면 확인 완료",drawing_files:[{name:"부산센텀_도면.pdf",size:312e3,url:"#"}],wall_upper_count:8,wall_lower_count:8,display_fixture_count:6,counter_drawer_1200_count:2,counter_shelf_1800_count:1,counter_shelf_1600_count:1,table_count:4,base_photo_note:"기초 사진 등록",base_photo_files:[{name:"부산센텀_기초사진.jpg",size:52e4,url:"#"}],special_notes:"미리보기 데이터",created_at:"2026-08-20T09:00:00+09:00"}],storeQuotes:[{store_name:"성수 플래그십",quote_status:"견적 확정",margin_rate:35,direct_cost:74e5,fixture_cost:0,cost_total:74e5,supply_amount:999e4,vat_amount:999e3,total_amount:10989e3}]},Ut=[{group:"벽장",name:"상부장",baseUnit:115600,allocationUnit:57100,quantity:40,madeAmount:126e4},{group:"벽장",name:"하부장",baseUnit:167500,allocationUnit:63500,quantity:40,madeAmount:224e4},{group:"진열장",name:"유리장",baseUnit:287e3,allocationUnit:163500,quantity:40,madeAmount:266e4},{group:"카운터",name:"카운터 서랍형 1200",baseUnit:831200,allocationUnit:727200,quantity:10,madeAmount:56e4},{group:"카운터",name:"카운터 선반형 1800",baseUnit:395800,allocationUnit:395800,quantity:4,madeAmount:256e3},{group:"카운터",name:"카운터 선반형 1600",baseUnit:350600,allocationUnit:350600,quantity:2,madeAmount:122e3},{group:"테이블",name:"테이블 600*1200",baseUnit:22e4,allocationUnit:161e3,quantity:5,madeAmount:805e3},{group:"도장",name:"도장 / 총 58통",baseUnit:18e4,allocationUnit:18e4,quantity:4,madeAmount:72e4}],Mt=["대시보드","엑셀 업로드","공사 시작 접수","결제 신청","결제 계좌 관리","첨부 파일 보기","매장별 공사 관리","진열장 원가 배분","견적서 생성","계약서 생성","은행 이체 파일 생성","관리자 설정"],pt={"전체 관리자":Mt,"인테리어 공사실장":["공사 시작 접수","결제 신청","결제 계좌 관리","첨부 파일 보기","진열장 원가 배분"]},zt={admin:"전체 관리자",interior_manager:"인테리어 공사실장","전체 관리자":"전체 관리자","인테리어 공사실장":"인테리어 공사실장"},re={"엑셀 업로드":["결제 신청 내역 엑셀 업로드","필수 컬럼 검증","중복/오류 행 표시"],"진열장 원가 배분":["매장별 진열장 비용 배분","공용 비용 자동 분배","평당 원가 반영"],"견적서 생성":["매장/업체 기준 견적서 생성","공사항목별 금액 자동 합산","PDF/문서 다운로드"],"계약서 생성":["업체 정보 기반 계약서 생성","계좌/사업자 정보 자동 반영","계약 상태 관리"],"은행 이체 파일 생성":["승인된 결제 건만 추출","은행 업로드용 파일 생성","이체 전 검증"],"첨부 파일 보기":["결제 증빙 확인","업체 서류 확인","공사 시작 파일 확인"],"관리자 설정":["사용자 권한","승인 단계","상태/분류 코드 관리"]},Ot="haka-active-view",se=()=>{try{return typeof window<"u"&&window.localStorage.getItem(Ot)||""}catch{return""}},ie=e=>{try{typeof window<"u"&&window.localStorage.setItem(Ot,e)}catch{}};let q=b,f=se()||"대시보드",P="인테리어 공사실장",w=null,I={startDate:"",endDate:""},E={startDate:"",endDate:"",keyword:"",readyStatus:"all"},J="",G="진행중",tt=[],V=null;const m=e=>new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW",maximumFractionDigits:0}).format(e||0),ft=()=>new Date().toISOString().slice(0,10),W=e=>Number(String(e).replace(/[^\d]/g,"")),y=e=>Number(e||0),rt=(e,t)=>String(e||"").trim().slice(0,t),ce=e=>String(e||"").replace(/[^\d]/g,""),le=e=>({"일시 지급":1,"선금 50%":.5,"잔금 50%":.5})[e]||0,Bt=e=>e==="사업소득 3.3%"?.033:0,g=e=>String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),_t=e=>String(e||"file").replace(/[^\w.\-가-힣]/g,"_"),et=e=>({승인:"green",신청:"amber",반려:"red",진행중:"blue",완료:"green",미착공:"gray",정상:"green",증빙확인:"amber",정산중:"amber","견적 확정":"blue","계약 완료":"green"})[e]||"gray";async function Vt(){if(tt=[],!u)return tt=[dt?"로컬 미리보기 데이터입니다. 실제 결제신청 건수는 배포 사이트에서 로그인 후 확인됩니다.":"Supabase 연결 정보가 없어 임시 데이터로 표시 중입니다."],dt?oe:b;const[e,t,n,a,o,r,s]=await Promise.all([u.from("payments").select("*").order("requested_at",{ascending:!1}).order("id",{ascending:!1}).limit(500),u.from("stores").select("*").order("id",{ascending:!0}),u.from("vendors").select("*").order("id",{ascending:!0}),u.from("construction_starts").select("*").order("created_at",{ascending:!1}).order("id",{ascending:!1}).limit(30),u.from("user_roles").select("email, role, created_at").order("email",{ascending:!0}),u.from("construction_cost_parts").select("part_name").order("part_name",{ascending:!0}),u.from("store_quotes").select("*").order("updated_at",{ascending:!1})]),l=[["결제 신청",e],["매장",t],["업체/계좌",n]].find(([,d])=>d.error);if(l)throw new Error(`${l[0]} 데이터를 불러오지 못했습니다. DB 연결과 권한을 확인해 주세요. (${l[1].error.message})`);[["공사 시작",a],["사용자 권한",o],["공사항목",r],["매장 견적",s]].forEach(([d,_])=>{_.error&&tt.push(`${d}: ${_.error.message}`)});const p=r.error?b.paymentItems:[...new Set([...Nt,...r.data.map(d=>d.part_name).filter(Boolean)])];return{payments:e.error?b.payments:e.data,stores:t.error?b.stores:t.data,vendors:n.error?b.vendors:n.data,constructionStarts:a.error?b.constructionStarts:a.data,userRoles:o.error?b.userRoles:o.data,paymentItems:p,storeQuotes:s.error?b.storeQuotes:s.data}}function ue(e){var n;const t=document.querySelector("#app");t.className="auth-shell",t.innerHTML=`
  ...
  `,(n=document.querySelector("[data-retry-load]"))==null||n.addEventListener("click",jt)}async function C(e=""){try{q=await Vt(),h(e)}catch(t){ue(t)}}async function Pt(e){if(!u||!(e!=null&&e.email))return"인테리어 공사실장";const{data:t,error:n}=await u.from("user_roles").select("role").ilike("email",e.email).maybeSingle();return n||!(t!=null&&t.role)?"인테리어 공사실장":zt[t.role]||"인테리어 공사실장"}async function jt(){var t;if(!u){P="전체 관리자",await C();return}const{data:e}=await u.auth.getSession();if(w=((t=e.session)==null?void 0:t.user)||null,!w){F();return}P=await Pt(w),ht(),await C()}function de(e,t,n){return e.payments.find(a=>{const o=a.vendor.trim()===t.trim(),r=Math.abs(a.amount-n)/Math.max(n,1);return o&&r<=.1})}function me(e,t,n){return e.payments.find(a=>{const o=String(a.store||"").trim()===t.trim(),r=String(a.payment_item||"").trim()===n.trim();return o&&r})}async function qt(e,t){const n=Array.from(e||[]).filter(o=>o.size>0);if(!n.length)return[];if(!u)return n.map(o=>({name:o.name,type:o.type,size:o.size,path:"",url:""}));const a=[];for(const o of n){const r=`${(w==null?void 0:w.id)||"user"}/${t}/${Date.now()}-${crypto.randomUUID()}-${_t(o.name)}`,{error:s}=await u.storage.from(wt).upload(r,o,{contentType:o.type||"application/octet-stream",upsert:!1});if(s)throw s;const{data:i}=u.storage.from(wt).getPublicUrl(r);a.push({name:o.name,type:o.type,size:o.size,path:r,url:i.publicUrl})}return a}async function ut(e,t){const n=Array.from(e||[]).filter(o=>o.size>0);if(!n.length)return[];if(!u)return n.map(o=>({name:o.name,type:o.type,size:o.size,path:"",url:""}));const a=[];for(const o of n){const r=`${(w==null?void 0:w.id)||"user"}/${t}/${Date.now()}-${crypto.randomUUID()}-${_t(o.name)}`,{error:s}=await u.storage.from(St).upload(r,o,{contentType:o.type,upsert:!1});if(s)throw s;const{data:i}=u.storage.from(St).getPublicUrl(r);a.push({name:o.name,type:o.type,size:o.size,path:r,url:i.publicUrl})}return a}async function Ct(e,t){const n=Array.from(e||[]).filter(o=>o.size>0);if(!n.length)return[];if(!u)return n.map(o=>({name:o.name,type:o.type,size:o.size,path:"",url:""}));const a=[];for(const o of n){const r=`${(w==null?void 0:w.id)||"user"}/${t}/${Date.now()}-${crypto.randomUUID()}-${_t(o.name)}`,{error:s}=await u.storage.from(kt).upload(r,o,{contentType:o.type,upsert:!1});if(s)throw s;const{data:i}=u.storage.from(kt).getPublicUrl(r);a.push({name:o.name,type:o.type,size:o.size,path:r,url:i.publicUrl})}return a}async function pe(e){e.preventDefault();const t=e.currentTarget,n=t.querySelector("button[type='submit']"),a=t.querySelector("[data-form-message]"),o=new FormData(t),r=Number(o.get("payment_id")||0),s=r?q.payments.find(S=>S.id===r&&S.status==="신청"):null,i=!!s,l=String(o.get("store")||"").trim(),p=String(o.get("vendor")||"").trim(),d=String(o.get("payment_item")||"").trim(),_=W(o.get("estimate_total")),R=String(o.get("payment_type")||"일시 지급"),$=W(o.get("amount")),x=String(o.get("tax_type")||"일반 송금"),N=Math.round($*Bt(x)),k=$-N,U=String(o.get("vendor_bank")||"").trim(),M=String(o.get("vendor_account_number")||"").trim(),Y=String(o.get("vendor_account_holder")||"").trim(),nt=String(o.get("memo")||"").trim(),j=de(q,p,$),z=(j==null?void 0:j.id)===r?null:j,K=me(q,l,d),c=(K==null?void 0:K.id)===r?null:K,v=o.getAll("estimate_files").filter(S=>S.size>0),D=o.getAll("tax_invoice_files").filter(S=>S.size>0),L=o.getAll("id_card_files").filter(S=>S.size>0),A=(s==null?void 0:s.attachment_files)||{},X=v.length||(A.estimate_files||[]).length,at=D.length||(A.tax_invoice_files||[]).length,ot=L.length||(A.id_card_files||[]).length;if(r&&!s){a.textContent="수정할 수 없는 결제 신청입니다. 이미 승인/반려 처리됐는지 확인해 주세요.",a.className="form-message error";return}if(!l||!p||!d||!_||!$||!U||!M||!Y){a.textContent="매장명, 업체, 결제 항목, 견적 총액, 신청 금액, 이체 계좌를 모두 입력해 주세요.",a.className="form-message error";return}if(x==="일반 송금"&&(!X||!at)){a.textContent="일반 송금은 견적서와 세금계산서를 첨부해야 합니다.",a.className="form-message error";return}if(x==="사업소득 3.3%"&&!ot){a.textContent="사업소득 3.3% 지급은 주민등록증 첨부가 필요합니다.",a.className="form-message error";return}n.disabled=!0,n.textContent="저장 중",a.textContent="첨부 자료를 업로드하고 있습니다.",a.className=z||c?"form-message warning":"form-message";let Z={};try{Z={estimate_files:[...A.estimate_files||[],...await ut(v,"estimates")],tax_invoice_files:[...A.tax_invoice_files||[],...await ut(D,"tax-invoices")],id_card_files:[...A.id_card_files||[],...await ut(L,"id-cards")]}}catch(S){n.disabled=!1,n.textContent=i?"수정 저장":"검토 요청 생성",a.textContent=`첨부 업로드 실패: ${S.message}`,a.className="form-message error";return}a.textContent=z?`중복 의심: ${z.store} / ${m(z.amount)} 건과 비슷합니다.`:c?`확인 필요: ${l} / ${d} 항목에 기존 신청이 있습니다. 중복이 아니면 견적서에는 같은 항목 합계로 반영됩니다.`:i?"수정 내용을 저장하고 있습니다.":"신청 건을 저장하고 있습니다.",a.className=z||c?"form-message warning":"form-message";const Q={store:l,vendor:p,payment_item:d,estimate_total:_,payment_type:R,amount:$,vendor_bank:U,vendor_account_number:M,vendor_account_holder:Y,tax_type:x,withholding_amount:N,net_amount:k,attachment_files:Z,estimate_group_mode:"매장별 항목 합산",estimate_group_key:`${l}::${d}`,memo:nt,status:"신청",requested_at:(s==null?void 0:s.requested_at)||ft()};if(!u)b.payments=i?b.payments.map(S=>S.id===r?{...S,...Q}:S):[{id:Date.now(),...Q},...b.payments];else{const{error:S}=i?await u.from("payments").update(Q).eq("id",r).eq("status","신청"):await u.from("payments").insert(Q);if(S){n.disabled=!1,n.textContent=i?"수정 저장":"검토 요청 생성",a.textContent=`저장 실패: ${S.message}`,a.className="form-message error";return}}t.reset(),V=null,await C(i?"결제 신청 수정이 저장됐습니다.":z?"신청이 저장됐습니다. 중복 의심 건은 결제 검토에서 확인하세요.":"신청이 저장됐습니다.")}async function fe(e){var d;e.preventDefault();const t=e.currentTarget,n=t.querySelector("button[type='submit']"),a=t.querySelector("[data-vendor-message]"),o=new FormData(t),r=Number(o.get("vendor_id")||0),s={name:String(o.get("name")||"").trim(),category:String(o.get("category")||"").trim(),bank:String(o.get("bank")||"").trim(),account_number:String(o.get("account_number")||"").trim(),account_holder:String(o.get("account_holder")||"").trim()},i=o.getAll("business_license_files").filter(_=>_.size>0),l=o.getAll("bankbook_files").filter(_=>_.size>0);if(!s.name||!s.category||!s.bank||!s.account_number||!s.account_holder){a.textContent="업체명, 분류, 은행, 계좌번호, 예금주를 모두 입력해 주세요.",a.className="form-message error";return}if(!r&&(!i.length||!l.length)){a.textContent="최초 등록 시 사업자등록증과 통장사본을 모두 첨부해 주세요.",a.className="form-message error";return}n.disabled=!0,n.textContent="저장 중",a.textContent="첨부 자료를 업로드하고 있습니다.",a.className="form-message";let p={};try{const _=r?((d=q.vendors.find(R=>R.id===r))==null?void 0:d.attachment_files)||{}:{};p={business_license_files:[..._.business_license_files||[],...await Ct(i,"business-licenses")],bankbook_files:[..._.bankbook_files||[],...await Ct(l,"bankbooks")]}}catch(_){n.disabled=!1,n.textContent="계좌 저장",a.textContent=`첨부 업로드 실패: ${_.message}`,a.className="form-message error";return}if(s.attachment_files=p,a.textContent="결제 계좌 정보를 저장하고 있습니다.",!u)b.vendors=r?b.vendors.map(_=>_.id===r?{..._,...s}:_):[{id:Date.now(),...s,risk:"정상",total:0},...b.vendors];else{const{error:_}=r?await u.from("vendors").update(s).eq("id",r):await u.from("vendors").insert(s);if(_){n.disabled=!1,n.textContent="계좌 저장",a.textContent=`저장 실패: ${_.message}`,a.className="form-message error";return}}t.reset(),f="결제 계좌 관리",await C(r?"결제 계좌 정보가 수정됐습니다.":"결제 계좌 정보가 저장됐습니다.")}async function _e(e){e.preventDefault();const t=e.currentTarget,n=t.querySelector("button[type='submit']"),a=t.querySelector("[data-store-message]"),o=new FormData(t),r={name:String(o.get("name")||"").trim(),area:Number(o.get("area")),status:String(o.get("status")||"미착공"),budget:W(o.get("budget")),spent:W(o.get("spent"))};if(!r.name||!r.area||!r.budget){a.textContent="매장명, 면적, 예산을 입력해 주세요.",a.className="form-message error";return}if(n.disabled=!0,n.textContent="저장 중",a.textContent="매장 공사 정보를 저장하고 있습니다.",a.className="form-message",!u)b.stores=[{id:Date.now(),...r},...b.stores];else{const{error:s}=await u.from("stores").insert(r);if(s){n.disabled=!1,n.textContent="매장 저장",a.textContent=`저장 실패: ${s.message}`,a.className="form-message error";return}}t.reset(),f="매장별 공사 관리",await C("매장 공사 정보가 저장됐습니다.")}async function ge(e){e.preventDefault();const t=e.currentTarget,n=t.querySelector("button[type='submit']"),a=t.querySelector("[data-construction-start-message]"),o=new FormData(t),r=y(o.get("wall_upper_count")),s=y(o.get("wall_lower_count")),i=y(o.get("display_fixture_count")),l=y(o.get("counter_drawer_1200_count")),p=y(o.get("counter_shelf_1800_count")),d=y(o.get("counter_shelf_1600_count")),_=l+p+d,R=Number(o.get("table_count")||0),$={store_name:String(o.get("store_name")||"").trim(),area:Number(o.get("area")),wall_upper_count:r,wall_lower_count:s,counter_drawer_1200_count:l,counter_shelf_1800_count:p,counter_shelf_1600_count:d,wall_cabinet_count:r+s,display_fixture_count:i,counter_count:_,fixture_count:r+s+i+_,table_count:R,sign_count:Number(o.get("sign_count")||0),special_notes:String(o.get("special_notes")||"").trim()};if(!$.store_name||!$.area){a.textContent="매장명과 평수는 꼭 입력해 주세요.",a.className="form-message error";return}n.disabled=!0,n.textContent="저장 중",a.textContent="도면과 사진 파일을 업로드하고 있습니다.",a.className="form-message";try{$.drawing_files=await qt(o.getAll("drawing_files"),"drawings"),$.base_photo_files=await qt(o.getAll("base_photo_files"),"base-photos")}catch(x){n.disabled=!1,n.textContent="공사 시작 정보 저장",a.textContent=`파일 업로드 실패: ${x.message}`,a.className="form-message error";return}if(a.textContent="공사 시작 정보를 저장하고 있습니다.",!u)b.constructionStarts=[{id:Date.now(),created_at:new Date().toISOString(),...$},...b.constructionStarts];else{const{error:x}=await u.from("construction_starts").insert($);if(x){n.disabled=!1,n.textContent="공사 시작 정보 저장",a.textContent=`저장 실패: ${x.message}`,a.className="form-message error";return}}t.reset(),f="공사 시작 접수",await C("공사 시작 정보가 저장됐습니다. 결제 신청 매장 검색에도 반영됐습니다.")}async function ve(e,t){if(!(!e||!["승인","반려"].includes(t))){if(!u)b.payments=b.payments.map(n=>n.id===e?{...n,status:t}:n);else{const{data:n,error:a}=await u.from("payments").update({status:t}).eq("id",e).eq("status","신청").select("id").maybeSingle();if(a){h(`상태 변경 실패: ${a.message}`);return}if(!n){V===e&&(V=null),f="결제 신청",await C("상태 변경 실패: 이미 처리됐거나 권한이 없습니다. 새로고침 후 다시 확인해 주세요.");return}}V===e&&(V=null),f="결제 신청",await C(`결제 신청이 ${t} 처리됐습니다.`)}}async function be(e){const t=[...new Set(e.map(Number).filter(Boolean))];if(!t.length){h("승인할 결제 신청을 먼저 선택해 주세요.");return}if(!u){b.payments=b.payments.map(o=>t.includes(o.id)&&o.status==="신청"?{...o,status:"승인"}:o),f="결제 신청",await C(`${t.length}건을 승인 처리했습니다.`);return}const{data:n,error:a}=await u.from("payments").update({status:"승인"}).in("id",t).eq("status","신청").select("id");if(a){h(`선택 승인 실패: ${a.message}`);return}f="결제 신청",await C(`${(n==null?void 0:n.length)||0}건을 승인 처리했습니다. 이제 엑셀 다운로드를 누르면 승인된 건이 내려갑니다.`)}async function xt(e,t){const n=document.querySelector(`[data-margin-rate="${CSS.escape(e)}"]`),a=Number((n==null?void 0:n.value)||35),o=bt(q,e,a),r=lt(q,e),s={store_name:e,quote_status:t,margin_rate:a,direct_cost:o.directCost,fixture_cost:o.fixtureCost,cost_total:o.costTotal,supply_amount:o.supplyAmount,vat_amount:o.vatAmount,total_amount:o.totalAmount,quote_confirmed_at:t==="견적 확정"?new Date().toISOString():r.quote_confirmed_at||new Date().toISOString(),contract_completed_at:t==="계약 완료"?new Date().toISOString():r.contract_completed_at||null,updated_at:new Date().toISOString()};if(!e||!o.costTotal||a<0){h("견적 확정 전에 승인된 결제 또는 진열장 배분 원가와 마진율을 확인해 주세요.");return}if(!u)b.storeQuotes=[{id:r.id||Date.now(),...s},...b.storeQuotes.filter(i=>i.store_name!==e)];else{const{error:i}=await u.from("store_quotes").upsert(s,{onConflict:"store_name"});if(i){h(`매장 견적 저장 실패: ${i.message}`);return}}J=e,f=t==="계약 완료"?"견적서 생성":"매장별 공사 관리",await C(t==="계약 완료"?`${e} 공사 완료 처리됐습니다. 견적서와 계약서를 확인할 수 있습니다.`:`${e} 견적이 확정됐습니다.`)}function he(e){var a;const t=String(e||"").replace(/\s/g,"");return((a=[["신한","신한"],["국민","국민"],["기업","기업"],["우리","우리"],["하나","하나"],["농협","농협"],["축협","농협"],["카카오","카카오"],["토스","토스"],["케이뱅크","케이뱅크"],["부산","부산"],["대구","아이엠뱅크"],["아이엠","아이엠뱅크"],["새마을","새마을금고"],["신협","신협"],["우체국","우체국"],["전북","전북"],["광주","광주"],["경남","경남"],["수협","수협"]].find(([o])=>t.includes(o)))==null?void 0:a[1])||rt(e,6)}function ye(e,t){const n=String(t.vendor||"").trim();return e.vendors.find(a=>String(a.name||"").trim()===n)||{}}function Kt(e){return e.payments.filter(t=>t.status==="승인")}function ct(e){return String(e.transfer_status||"미작성").trim()||"미작성"}function gt(e){return["송금완료","이체완료"].includes(ct(e))}function $e(e){return Kt(e).filter(t=>!gt(t))}function we(e){if(!e.ready)return"red";const t=ct(e.payment);return gt(e.payment)?"green":t==="파일생성"?"blue":"gray"}function Se(e){if(!e.ready)return"계좌정보 확인";const t=ct(e.payment);return t==="미작성"?"파일 미생성":t}function Dt(e){const t=String(e||"");return t?t.includes("T")?t.slice(0,16).replace("T"," "):t.slice(0,10):""}function ke(){const e=new Date().toISOString().replace(/[-:TZ.]/g,"").slice(0,14),t=Math.random().toString(36).slice(2,8).toUpperCase();return`TR-${e}-${t}`}function qe(e,t){const n=ye(e,t),a=t.vendor_bank||n.bank,o=t.vendor_account_number||n.account_number,r=t.vendor_account_holder||n.account_holder||t.vendor,s=Number(t.net_amount||t.amount||0),i=`${t.store||""} ${t.payment_item||""}`.trim();return{bank:he(a),account:ce(o),holder:r,amount:s,withdrawMemo:"하카공사비",depositMemo:rt(r,7),payerCode:"",memo:rt(i,10),key:rt(`${t.id||""}-${t.requested_at||ft()}`,20),payment:t,vendor:n,ready:!!(a&&o&&r&&s>0)}}function Xt(e,t,n){const a=String(e||"").slice(0,10);return!(!a||t&&a<t||n&&a>n)}function Ce(e){return!(I.startDate||I.endDate)?e:{...e,payments:e.payments.filter(n=>Xt(n.requested_at,I.startDate,I.endDate))}}function mt(e,t={}){var s;const n=(s=t.selectedIds)!=null&&s.length?new Set(t.selectedIds.map(String)):null,a=!!(t.startDate||t.endDate),o=String(t.keyword||"").trim().toLowerCase(),r=t.readyStatus||"all";return $e(e).filter(i=>!a||Xt(i.requested_at,t.startDate,t.endDate)).filter(i=>!n||n.has(String(i.id))).map(i=>qe(e,i)).filter(i=>o?[i.payment.store,i.payment.vendor,i.payment.payment_item,i.bank,i.account,i.holder].join(" ").toLowerCase().includes(o):!0).filter(i=>r==="ready"?i.ready:r==="missing"?!i.ready:!0)}async function xe(e,t){const n=[...new Set(e.map(i=>Number(i.payment.id)).filter(Boolean))];if(!n.length)return{updated:0};const a=new Date().toISOString(),o={transfer_batch_id:t,exported_at:a,transfer_status:"파일생성"};if(!u)return b.payments=b.payments.map(i=>n.includes(i.id)&&i.status==="승인"?{...i,...o}:i),q=await Vt(),{updated:n.length};const{data:r,error:s}=await u.from("payments").update(o).in("id",n).eq("status","승인").select("id");return s?{error:s}:{updated:(r==null?void 0:r.length)||0}}async function De(e){const t=[...new Set(e.map(Number).filter(Boolean))];if(!t.length){h("송금완료 처리할 이체건을 먼저 선택해 주세요.");return}if(!window.confirm(`${t.length}건을 송금완료로 처리할까요? 처리 후 이체자료조회 대상에서 제외됩니다.`))return;const n={transfer_status:"송금완료",transferred_at:new Date().toISOString(),transfer_memo:"화면에서 송금완료 처리"};if(!u){b.payments=b.payments.map(r=>t.includes(r.id)&&r.status==="승인"?{...r,...n}:r),f="은행 이체 파일 생성",await C(`${t.length}건을 송금완료 처리했습니다.`);return}const{data:a,error:o}=await u.from("payments").update(n).in("id",t).eq("status","승인").select("id");if(o){h(`송금완료 처리 실패: ${o.message}`);return}f="은행 이체 파일 생성",await C(`${(a==null?void 0:a.length)||0}건을 송금완료 처리했습니다.`)}async function Ae(e,t={}){const n=Array.isArray(t.selectedIds)&&t.selectedIds.length>0,a=!!(t.startDate||t.endDate);if(!n&&!a){h("이체 파일은 전체 승인건을 자동으로 만들지 않습니다. 이체대상을 체크하거나 날짜 범위를 조회한 뒤 다운로드해 주세요.");return}const o=mt(e,t).filter(k=>k.ready);if(!o.length){h("다운로드할 승인 완료 건이 없거나, 업체 계좌정보가 비어 있습니다.");return}if(!window.XLSX){h("엑셀 생성 모듈을 불러오지 못했습니다. 새로고침 후 다시 시도해 주세요.");return}const r=["*입금은행","*입금계좌","*입금액","고객관리성명"],s=o.map(k=>[k.bank,k.account,Math.round(Number(k.amount||0)),k.holder]),i=window.XLSX.utils.aoa_to_sheet([r,...s]);for(let k=2;k<=s.length+1;k+=1){const U=i[`B${k}`],M=i[`C${k}`];U&&(U.t="s",U.z="@"),M&&(M.t="n",M.z="0")}i["!cols"]=[{wch:12},{wch:22},{wch:14},{wch:24}];const l=window.XLSX.utils.book_new();window.XLSX.utils.book_append_sheet(l,i,"입력정보");const p=window.XLSX.write(l,{bookType:"xls",type:"array"}),d=new Blob([p],{type:"application/vnd.ms-excel"}),_=URL.createObjectURL(d),R=ke(),$=document.createElement("a");$.href=_;const x=t.startDate||t.endDate?`_${t.startDate||"처음"}_${t.endDate||"오늘"}`:"";$.download=`은행대량이체${x}_${R}_${o.length}건.xls`,document.body.appendChild($),$.click(),$.remove(),URL.revokeObjectURL(_);const N=await xe(o,R);if(N.error){h(`이체 파일 ${o.length}건은 생성했지만 상태 저장에 실패했습니다: ${N.error.message}`);return}f="은행 이체 파일 생성",await C(`이체 파일 ${o.length}건을 생성하고 ${N.updated}건을 파일생성 상태로 표시했습니다.`)}function At(e){const t=e.querySelector("[name='estimate_total']"),n=e.querySelector("[name='payment_type']"),a=e.querySelector("[name='amount']"),o=le(n.value),r=W(t.value);!o||!r||(a.value=String(Math.round(r*o)),st(e))}function st(e){var i,l;const t=W((i=e.querySelector("[name='amount']"))==null?void 0:i.value),n=((l=e.querySelector("[name='tax_type']"))==null?void 0:l.value)||"일반 송금",a=Math.round(t*Bt(n)),o=t-a,r=e.querySelector("[data-withholding-preview]"),s=e.querySelector("[data-net-preview]");r&&(r.textContent=m(a)),s&&(s.textContent=m(o))}function Et(e){var a;const t=String(((a=e.querySelector("[name='vendor']"))==null?void 0:a.value)||"").trim(),n=q.vendors.find(o=>String(o.name||"").trim()===t);n&&(e.querySelector("[name='vendor_bank']").value=n.bank||"",e.querySelector("[name='vendor_account_number']").value=n.account_number||"",e.querySelector("[name='vendor_account_holder']").value=n.account_holder||"")}function Ee(e){const t=q.vendors.find(a=>a.id===e),n=document.querySelector("#vendor-form");!t||!n||(n.querySelector("[name='vendor_id']").value=t.id,n.querySelector("[name='name']").value=t.name||"",n.querySelector("[name='category']").value=t.category||"",n.querySelector("[name='bank']").value=t.bank||"",n.querySelector("[name='account_number']").value=t.account_number||"",n.querySelector("[name='account_holder']").value=t.account_holder||"",n.querySelector("button[type='submit']").textContent="계좌 수정",n.querySelector("[data-vendor-message]").textContent="기존 계좌 정보를 수정 중입니다. 새 파일을 첨부하면 기존 파일에 추가됩니다.")}function Le(e){const t=e.stores.filter(d=>d.status==="완료").length,n=e.stores.filter(d=>d.status==="진행중").length,a=e.stores.filter(d=>d.document_required).length,o=e.payments.filter(d=>d.status==="승인").reduce((d,_)=>d+_.amount,0),r=e.stores.reduce((d,_)=>d+Number(_.spent||0),0),s=e.payments.filter(d=>d.status==="신청").length,i=e.stores.filter(d=>String(d.name||"").includes("직영점")).length,l=e.stores.reduce((d,_)=>d+Number(_.area||0),0),p=Math.round(r/Math.max(l,1));return[["완료된 매장",`${t}개`,"엑셀 공사 상태 기준"],["진행중인 매장",`${n}개`,"시공 또는 비용 검수 중"],["전체 공사비",m(r),"엑셀 합계 기준"],["문서 생성 대상",`${a}개`,"강남압구정 행부터 아래"],["대기중인 결제",`${s}건`,"승인 전 검토 필요"],["직영점",`${i}개`,"지점명 기준"],["승인된 결제",m(o),"지급 승인 완료"],["평균 평당 원가",m(p),"엑셀 합계/평수 기준"]]}function T(e,t){return`
  ...
  `:'<div class="empty">표시할 결제 신청이 없습니다.</div>'}function Re(e,t=!1){return e.length?e.map(n=>`
      ...
      </tr>`).join(""):`<tr><td colspan="${t?12:11}">조회된 이체 대상이 없습니다.</td></tr>`}function lt(e,t){return e.storeQuotes.find(n=>n.store_name===t)||{}}function Ht(e,t){return e.constructionStarts.find(n=>n.store_name===t)||{}}function H(e,t){const n=Ut.find(a=>{const o=a.group===e,r=t.every(s=>a.name.includes(s));return o&&r});return n?ee(n):0}function Fe(e,t){return e.payments.filter(n=>{const a=n.store===t,o=n.status==="승인",r=String(n.payment_item||""),s=r.includes("진열장")||r.includes("벽장")||r.includes("카운터");return a&&o&&!s}).reduce((n,a)=>n+Number(a.amount||0),0)}function vt(e,t){const n=Ht(e,t),a=y(n.wall_upper_count??n.wall_cabinet_count),o=y(n.wall_lower_count),r=y(n.display_fixture_count??n.fixture_count),s=y(n.counter_drawer_1200_count??n.counter_count),i=y(n.counter_shelf_1800_count),l=y(n.counter_shelf_1600_count),p=y(n.table_count);return a*H("벽장",["상부장"])+o*H("벽장",["하부장"])+r*H("진열장",["유리장"])+s*H("카운터",["서랍형","1200"])+i*H("카운터",["선반형","1800"])+l*H("카운터",["선반형","1600"])+p*H("테이블",["600*1200"])}function Qt(e){const t=[...e.stores.map(n=>n.name),...e.constructionStarts.map(n=>n.store_name),...e.payments.map(n=>n.store)];return[...new Set(t.map(n=>String(n||"").trim()).filter(Boolean))]}function Jt(e,t){return e.stores.find(n=>n.name===t)||{}}function Wt(e,t){const n=Jt(e,t);return n.status==="완료"&&!n.document_required}function Ne(e,t){const n=lt(e,t),a=Jt(e,t);return n.quote_status==="계약 완료"||a.status==="완료"&&!!a.document_required}function it(e,t="진행중"){return Qt(e).filter(n=>{if(Wt(e,n))return!1;const a=Ne(e,n);return t==="완료"?a:!a})}function Yt(e){return Qt(e).filter(t=>!Wt(e,t))}function bt(e,t,n){const a=Fe(e,t),o=vt(e,t),r=a+o,s=Math.round(r*(1+y(n)/100)),i=Math.round(s*.1),l=s+i;return{directCost:a,fixtureCost:o,costTotal:r,supplyAmount:s,vatAmount:i,totalAmount:l}}function Ue(e,t,n){const a=new Map;e.payments.filter(r=>{const s=r.store===t,i=r.status==="승인",l=String(r.payment_item||""),p=l.includes("진열장")||l.includes("벽장")||l.includes("카운터");return s&&i&&!p}).forEach(r=>{const s=r.payment_item||"기타 공사";a.set(s,(a.get(s)||0)+Number(r.amount||0))});const o=vt(e,t);return o>0&&a.set("진열장 원가 배분",(a.get("진열장 원가 배분")||0)+o),[...a.entries()].map(([r,s])=>{const i=Math.round(s*(1+y(n)/100)),l=Math.round(i*.1);return{name:r,cost:s,supply:i,vat:l,total:i+l}})}function Me(e,t="진행중"){return it(e,t).map(n=>{const a=lt(e,n),o=a.margin_rate??35,r=bt(e,n,o),s=a.quote_status||"정산중";return`
      <tr>
        <td>${n}</td>
        ...
        <td><input class="inline-input" data-margin-rate="${g(n)}" inputmode="decimal" value="${o}" /></td>
      ...
      </tr>`)}function Lt(e,t=""){const n=Array.isArray(e)?e:[];return n.length?n.map(a=>a.url?`<a href="${g(a.url)}" target="_blank" rel="noreferrer">${g(a.name||"파일")}</a>`:`<span>${g(a.name||"파일")}</span>`).join("<br />"):t||"-"}function Zt(e){const t=e.attachment_files||{},n=(t.estimate_files||[]).length,a=(t.tax_invoice_files||[]).length,o=(t.id_card_files||[]).length;return e.tax_type==="사업소득 3.3%"?o?`주민등록증 ${o}개`:"주민등록증 필요":`견적서 ${n}개 / 세금계산서 ${a}개`}function Oe(e){const t=Number(e||0);return t?t>=1024*1024?`${(t/1024/1024).toFixed(1)}MB`:t>=1024?`${Math.round(t/1024)}KB`:`${t}B`:"-"}function Be(e){const t=[],n=(a,o,r,s,i="")=>{(Array.isArray(s)?s:[]).forEach(l=>{t.push({source:a,owner:o,category:r,name:l.name||"파일",size:Oe(l.size),date:i,url:l.url||""})})};return e.payments.forEach(a=>{const o=a.attachment_files||{},r=`${a.store||"-"} / ${a.vendor||"-"}`,s=a.requested_at||"";n("결제 신청",r,"견적서",o.estimate_files,s),n("결제 신청",r,"세금계산서",o.tax_invoice_files,s),n("결제 신청",r,"주민등록증",o.id_card_files,s)}),e.vendors.forEach(a=>{const o=a.attachment_files||{};n("업체 계좌",a.name||"-","사업자등록증",o.business_license_files),n("업체 계좌",a.name||"-","통장사본",o.bankbook_files)}),e.constructionStarts.forEach(a=>{const o=String(a.created_at||"").slice(0,10);n("공사 시작",a.store_name||"-","도면",a.drawing_files,o),n("공사 시작",a.store_name||"-","기초 사진",a.base_photo_files,o)}),t.length?t.map(a=>`
      <tr>
        <td>${a.source}</td>
        <td>${g(a.owner)}</td>
        <td>${a.category}</td>
        <td>${a.url?`<a href="${g(a.url)}" target="_blank" rel="noreferrer">${g(a.name)}</a>`:g(a.name)}</td>
        <td>${a.size}</td>
        <td>${a.date||"-"}</td>
        <td>${a.url?`<a class="file-open-link" href="${g(a.url)}" target="_blank" rel="noreferrer">열기</a>`:"-"}</td>
      ...
      <tr>
      ...
      </tr>`)}function Gt(e){return e.vendors.map(t=>{const n=t.attachment_files||{},a=(n.business_license_files||[]).length,o=(n.bankbook_files||[]).length;return`
        <tr>
          <td>${t.name}</td>
          <td>${t.category}</td>
          <td>${t.bank}</td>
        ...
        </tr>`})}function Pe(e){return e.vendors.map(t=>`<option value="${g(t.name)}">${g(t.name)} / ${g(t.bank)} ${g(t.account_number||"")}</option>`).join("")}function je(e){const n=[...e.constructionStarts.map(o=>({name:o.store_name,area:o.area,status:"공사 시작 접수"})),...e.stores],a=new Set;return n.filter(o=>{const r=String(o.name||"").trim();return!r||a.has(r)?!1:(a.add(r),!0)}).map(o=>`<option value="${g(o.name)}">${g(o.name)} / ${g(o.area)}평 / ${g(o.status)}</option>`).join("")}function Ke(e){return e.paymentItems.map(t=>`<option value="${g(t)}">${g(t)}</option>`).join("")}function O(e,t){return e===t?"selected":""}function te(){const e=q.payments.find(a=>a.id===V&&a.status==="신청"),t=!!e,n=(a,o="")=>g((e==null?void 0:e[a])??o);return`
  ...
  `}function Je(e){const t=B().includes("은행 이체 파일 생성"),n=Ce(e),a=n.payments.filter(r=>r.status==="신청").length,o=I.startDate||I.endDate?`${I.startDate||"처음"} ~ ${I.endDate||"오늘"}`:"전체 기간";return`
    <section class="grid">
      <article class="panel">
        <div class="panel-head">
          <h2>결제 신청 조회</h2>
          <div class="summary-pills">
            <span>조회 결과 <strong>${n.payments.length}건</strong></span>
            <span class="warning">승인 대기 <strong>${a}건</strong></span>
          </div>
        </div>
        ...
        <div class="result-summary">
          <strong>${n.payments.length}건</strong>
          <span>조회기간 ${o}</span>
          <span>승인 대기 ${a}건</span>
        </div>
      </article>
  ...
  `}function We(e){const t=mt(e),n=mt(e,E),a=Kt(e).filter(p=>gt(p)).length,o=n.filter(p=>p.ready).length,r=n.length-o,s=n.filter(p=>ct(p.payment)==="파일생성").length,i=n.filter(p=>p.ready).reduce((p,d)=>p+d.amount,0),l=E.startDate||E.endDate?`${E.startDate||"처음"} ~ ${E.endDate||"오늘"}`:"전체 기간";return`
  ...
  `}function ee(e){return e.quantity&&e.madeAmount?Math.round(e.madeAmount/e.quantity):e.allocationUnit||e.baseUnit||0}function Ge(){return Ut.map(e=>`
      ...
      </tr>`)}function tn(e){return e.constructionStarts.map(t=>{const n=y(t.wall_upper_count??t.wall_cabinet_count),a=y(t.wall_lower_count),o=y(t.display_fixture_count??t.fixture_count),r=y(t.counter_drawer_1200_count??t.counter_count),s=y(t.counter_shelf_1800_count),i=y(t.counter_shelf_1600_count),l=y(t.table_count),p=vt(e,t.store_name);return`
      <tr>
        <td>${t.store_name}</td>
        <td>${n}</td>
        <td>${a}</td>
  ...
  `}function an(e){const t=it(e,G),n=it(e,"진행중").length,a=it(e,"완료").length;return`
    <section class="grid">
      <article class="panel">
        <div class="panel-head">
        ...
        <div class="segmented-tabs">
          ...
          <button class="${G==="완료"?"active":""}" data-store-management-filter="완료">완료 매장 ${a}건</button>
        </div>
  ...
  `}function on(e){return Yt(e).map(t=>`<option value="${g(t)}" ${t===J?"selected":""}>${g(t)}</option>`).join("")}function rn(e){return e.map((t,n)=>`
      ...
      </tr>`)}function It(e,t){const n=Yt(e),a=J||n[0]||"";J=a;const o=lt(e,a),r=o.margin_rate??35,s=bt(e,a,r),i=Ue(e,a,r),l=Ht(e,a),p=t==="계약서 생성";return a?`
    <section class="grid">
      <article class="panel">
        <div class="panel-head">
          <h2>${t}</h2>
        ...
        <section class="document-preview">
          ...
          <div class="document-meta">
            <div><span>매장명</span><strong>${a}</strong></div>
            <div><span>평수</span><strong>${l.area?`${l.area}평`:"-"}</strong></div>
            <div><span>상태</span><strong>${o.quote_status||"정산중"}</strong></div>
            <div><span>마진율</span><strong>${r}%</strong></div>
          </div>
          ${p?`<div class="contract-body">
                  <p>본 계약은 ${a} 공사와 관련하여 승인된 결제 원가와 진열장 원가 배분 내역을 기준으로 산정한 최종 공사금액을 계약 기준으로 한다.</p>
  ...
  `,document.querySelector("#auth-form").addEventListener("submit",pn),document.querySelector("[data-auth-action='signup']").addEventListener("click",fn),document.querySelector("[data-auth-action='resend']").addEventListener("click",_n)}async function pn(e){e.preventDefault();const t=new FormData(e.currentTarget),n=String(t.get("email")||"").trim(),a=String(t.get("password")||"");if(!n||!a){F("이메일과 비밀번호를 입력해 주세요.");return}const{data:o,error:r}=await u.auth.signInWithPassword({email:n,password:a});if(r){F(`로그인 실패: ${r.message}`);return}w=o.user,P=await Pt(w),ht(),await C()}async function fn(){const e=document.querySelector("#auth-form"),t=new FormData(e),n=String(t.get("email")||"").trim(),a=String(t.get("password")||"");if(!n||!a){F("계정을 만들 이메일과 비밀번호를 입력해 주세요.");return}const{error:o}=await u.auth.signUp({email:n,password:a,options:{emailRedirectTo:window.location.origin+window.location.pathname}});if(o){F(`회원가입 실패: ${o.message}`);return}F("계정이 생성됐습니다. 이메일 확인이 필요한 경우 메일 인증 후 로그인해 주세요.")}async function _n(){const e=document.querySelector("#auth-form"),t=new FormData(e),n=String(t.get("email")||"").trim();if(!n){F("인증메일을 다시 받을 이메일을 입력해 주세요.");return}const{error:a}=await u.auth.resend({type:"signup",email:n,options:{emailRedirectTo:window.location.origin+window.location.pathname}});if(a){F(`인증메일 재발송 실패: ${a.message}`);return}F("인증메일을 다시 보냈습니다. 새로 받은 메일의 링크를 눌러 주세요.")}async function gn(){await u.auth.signOut(),w=null,P="인테리어 공사실장",F("로그아웃되었습니다.")}function h(e=""){var s,i,l,p,d,_,R,$,x,N,k,U,M,Y,nt,j,z,K;const t=document.querySelector("#app");t.className=f==="은행 이체 파일 생성"?"transfer-app":"",ht(),t.innerHTML=`
    <aside class="sidebar">
      <div class="brand">
        <span class="brand-mark">H</span>
        <div>
