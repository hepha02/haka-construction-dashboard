...
create table if not exists public.construction_starts (
  ...
  wall_upper_count integer not null default 0,
  wall_lower_count integer not null default 0,
  wall_cabinet_count integer not null default 0,
  display_fixture_count integer not null default 0,
  counter_drawer_1200_count integer not null default 0,
  counter_shelf_1800_count integer not null default 0,
  counter_shelf_1600_count integer not null default 0,
